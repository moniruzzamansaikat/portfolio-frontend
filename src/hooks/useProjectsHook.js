  ...
  const [projects] = useState([
    {
      ...
      used: ['react', 'firebase ', 'context api', 'node', 'mongodb', 'heroku'],
    ...
    },
    {
      ...
      used: ['php', 'laravel', 'tailwindcss', 'mysql', 'cpanel'],
      live: 'https://laravel1.saikim.net/',
      code: 'https://github.com/moniruzzamansaikat/laravex',
      images: ['/img/projects/laravex/img1.jpg'],
    },
    {
      title: 'E-Sport Template',
      category: 'Frontend',
      featured: true,
      description: 'This is multipage responsive website for e-sports.',
      used: ['html', 'css', 'bootstrap', 'jquery'],
      live: 'https://moniruzzamansaikat.github.io/sport-static/index.html',
      code: 'https://github.com/moniruzzamansaikat/sport-static',
      images: ['/img/projects/sport-template/img1.jpg'],
    },
    {
      title: 'NextJS Web',
      category: 'Frontend',
      featured: true,
      description: 'This is a one page web template built with next.js. ',
      used: ['react', 'next', 'bootstrap', 'react-sidebar', 'sass', 'vercel'],
